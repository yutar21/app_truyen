...
export const ROMANCE_LEVELS = [
  {
    id: 'none', name: 'Không viết tuyến tình cảm', short: 'Thuần sự nghiệp / quyền mưu / huyền nghi, tình cảm chỉ là bối cảnh lướt qua',
    rules: '本书不铺感情线。异性角色按功能人物写（对手、伙伴、上级、客户），不给暧昧笔墨、不写心动、不设三角。'
      + '涉及婚恋只作背景交代（「他媳妇」「他家那口子」），一句带过，不展开。Không viết tuyến tình cảm, tập trung sự nghiệp/tu luyện.',
  },
  {
    id: 'light', name: 'Nhạt (Điểm xuyết chừng mực)', short: 'Có tình cảm nhưng tiết chế, vài chục chương tiến một bước nhỏ',
    rules: '感情线存在但克制：几十章推进一小步，靠一两个细节维持（一句话、一个物件、一次并肩），'
      + '不设三角、不写吃醋、不做感情高潮。异性角色首先是有自己欲望的人，其次才是感情对象。Tình cảm tiết chế nhẹ nhàng.',
  },
  {
    id: 'warm', name: 'Mập mờ lôi cuốn (Khuyên dùng)', short: 'Sức căng lớn, lôi cuốn, dựa vào khoảng lặng và vật định tình, không tả thân thể',
  ...
  {
    id: 'bold', name: 'Nồng thắm (Nhân vật trưởng thành)', short: 'Ôm hôn thân mật đúng lúc, tả xúc cảm không tả bộ phận, tả sức căng không lộ liễu',
    rules: '感情戏是本书主线之一，篇幅和分量要给足。**标准是「色而不淫」——不是回避，是写而不露**：\n'
      ...
      + '越线的代价是整本书下架——写到八分收手，是本事，不是怯懦。Tình cảm sâu sắc, văn minh đúng chuẩn.',
  },
];
